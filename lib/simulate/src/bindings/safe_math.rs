...
pub mod safe_math {
    ...
    impl<M> ::core::fmt::Debug for SafeMath<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SafeMath))
                .field(&self.address())
                .finish()
        }
    }
