...
use ethers::{
    ...
    providers::{Middleware, Provider, PendingTransaction, MiddlewareError, LogQuery, FilterKind, FilterWatcher, PubsubClient, SubscriptionStream, erc, NodeInfo, PeerInfo}, types::{Address, transaction::{eip2718::TypedTransaction, eip2930::AccessListWithGasUsed}, BlockId, U64, U256, H256, Block, Transaction, TxHash, Bytes, NameOrAddress, TransactionReceipt, BlockNumber, Filter, Log, TxpoolContent, TxpoolInspect, TxpoolStatus, FeeHistory, Trace, TraceFilter, BlockTrace, TraceType, GethTrace, GethDebugTracingOptions, GethDebugTracingCallOptions, EIP1186ProofResponse, SyncingStatus}, abi::ethereum_types::Signature,
};
...
impl<M> Middleware for SimulationMiddleware<M>
where
    M: Middleware,
{
        ...
        fn provider(&self) -> &Provider<Self::Provider> {
            unimplemented!("revm does not need a provider.")
        }
        ...
        async fn send_transaction<T: Into<TypedTransaction> + Send + Sync>(
            ...
            todo!("we should be able to send the transaction.")
        }
        ...
        async fn is_signer(&self) -> bool {
            unimplemented!("should we be able to check if we are a signer (I'm not sure how this works).")
        }
