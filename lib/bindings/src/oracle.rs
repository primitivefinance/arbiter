...
pub mod oracle {
    ...
    impl<M> ::core::fmt::Debug for Oracle<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Oracle)).field(&self.address()).finish()
        }
    }
