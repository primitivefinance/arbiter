...
pub mod migrations {
    ...
    impl<M> ::core::fmt::Debug for Migrations<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Migrations)).field(&self.address()).finish()
        }
    }
