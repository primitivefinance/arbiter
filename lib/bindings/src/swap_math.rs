...
pub mod swap_math {
    ...
    impl<M> ::core::fmt::Debug for SwapMath<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SwapMath)).field(&self.address()).finish()
        }
    }
