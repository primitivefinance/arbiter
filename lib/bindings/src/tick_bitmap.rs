...
pub mod tick_bitmap {
    ...
    impl<M> ::core::fmt::Debug for TickBitmap<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(TickBitmap)).field(&self.address()).finish()
        }
    }
