...
pub mod babylonian {
    ...
    impl<M> ::core::fmt::Debug for Babylonian<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Babylonian)).field(&self.address()).finish()
        }
    }
