...
pub mod bit_math {
    ...
    impl<M> ::core::fmt::Debug for BitMath<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(BitMath)).field(&self.address()).finish()
        }
    }
