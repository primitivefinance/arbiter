...
pub mod low_gas_safe_math {
    ...
    impl<M> ::core::fmt::Debug for LowGasSafeMath<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(LowGasSafeMath))
                .field(&self.address())
                .finish()
        }
    }
