...
pub mod tick_math {
    ...
    impl<M> ::core::fmt::Debug for TickMath<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(TickMath)).field(&self.address()).finish()
        }
    }
