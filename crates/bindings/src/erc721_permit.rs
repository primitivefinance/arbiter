...
pub mod erc721_permit {
    ...
    pub static ERC721PERMIT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    impl<M> ::core::fmt::Debug for ERC721Permit<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC721Permit)).field(&self.address()).finish()
        }
    }
