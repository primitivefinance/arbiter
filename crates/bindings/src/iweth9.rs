...
pub mod iweth9 {
    ...
    impl<M> ::core::fmt::Debug for IWETH9<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IWETH9)).field(&self.address()).finish()
        }
    }
