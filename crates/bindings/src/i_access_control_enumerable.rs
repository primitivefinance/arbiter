...
pub mod i_access_control_enumerable {
    ...
    impl ::core::convert::From<RoleAdminChangedFilter> for IAccessControlEnumerableEvents {
    ...
    impl ::core::convert::From<GetRoleMemberCountCall> for IAccessControlEnumerableCalls {
