...
pub mod periphery_immutable_state {
    ...
    pub static PERIPHERYIMMUTABLESTATE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for PeripheryImmutableState<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(PeripheryImmutableState))
                .field(&self.address())
                .finish()
        }
    }
    ...
    pub enum PeripheryImmutableStateCalls {
        Weth9(Weth9Call),
        Factory(FactoryCall),
    }
    impl ::ethers::core::abi::AbiDecode for PeripheryImmutableStateCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for PeripheryImmutableStateCalls {
    ...
    impl ::core::fmt::Display for PeripheryImmutableStateCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<Weth9Call> for PeripheryImmutableStateCalls {
        fn from(value: Weth9Call) -> Self {
            Self::Weth9(value)
        }
    }
    impl ::core::convert::From<FactoryCall> for PeripheryImmutableStateCalls {
