...
pub mod erc20_flash_mint {
    ...
    pub static ERC20FLASHMINT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    impl<M> ::core::fmt::Debug for ERC20FlashMint<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC20FlashMint)).field(&self.address()).finish()
        }
    }
