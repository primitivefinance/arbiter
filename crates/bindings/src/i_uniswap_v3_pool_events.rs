...
pub mod i_uniswap_v3_pool_events {
    ...
    impl<M: ::ethers::providers::Middleware> IUniswapV3PoolEvents<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<M, IUniswapV3PoolEventsEvents> {
    ...
    impl ::std::fmt::Display for IUniswapV3PoolEventsEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                IUniswapV3PoolEventsEvents::CollectProtocolFilter(element) => {
                    element.fmt(f)
                }
                ...
                IUniswapV3PoolEventsEvents::SetFeeProtocolFilter(element) => {
                    element.fmt(f)
                }
