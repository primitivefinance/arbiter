...
pub mod encoder_target {
    ...
    impl<M: ::ethers::providers::Middleware> EncoderTarget<M> {
        ...
        ///Calls the contract's `allocateOrDeallocate` (0x71b5ec7b) function
    ...
    ///Container type for all input parameters for the `allocateOrDeallocate` function with signature `allocateOrDeallocate(bool,uint8,uint64,uint128,uint128,uint128)` and selector `0x71b5ec7b`
    #[derive(
        Clone,
    ...
    #[ethcall(
        ...
        abi = "allocateOrDeallocate(bool,uint8,uint64,uint128,uint128,uint128)"
    )]
    ...
    ///Container type for all return fields from the `allocateOrDeallocate` function with signature `allocateOrDeallocate(bool,uint8,uint64,uint128,uint128,uint128)` and selector `0x71b5ec7b`
    #[derive(
        Clone,
