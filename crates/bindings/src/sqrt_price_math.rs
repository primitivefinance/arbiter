...
pub mod sqrt_price_math {
    ...
    impl<M> ::core::fmt::Debug for SqrtPriceMath<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SqrtPriceMath))
                .field(&self.address())
                .finish()
        }
    }
