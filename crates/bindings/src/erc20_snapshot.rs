...
pub mod erc20_snapshot {
    ...
    pub static ERC20SNAPSHOT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> ERC20Snapshot<M> {
        ...
        pub fn snapshot_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, SnapshotFilter> {
            self.0.event()
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ERC20SnapshotEvents>
        {
            self.0
