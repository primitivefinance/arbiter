...
pub mod erc20_snapshot {
    ...
    pub static ERC20SNAPSHOT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20Snapshot<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ERC20Snapshot<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ERC20Snapshot<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ERC20Snapshot<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ERC20Snapshot<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC20Snapshot)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ERC20Snapshot<M> {
    ...
    pub enum ERC20SnapshotEvents {
        ApprovalFilter(ApprovalFilter),
        SnapshotFilter(SnapshotFilter),
        TransferFilter(TransferFilter),
    }
    impl ::ethers::contract::EthLogDecode for ERC20SnapshotEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(ERC20SnapshotEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = SnapshotFilter::decode_log(log) {
                return Ok(ERC20SnapshotEvents::SnapshotFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(ERC20SnapshotEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for ERC20SnapshotEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for ERC20SnapshotEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<SnapshotFilter> for ERC20SnapshotEvents {
        fn from(value: SnapshotFilter) -> Self {
            Self::SnapshotFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for ERC20SnapshotEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC20SnapshotCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC20SnapshotCalls {
    ...
    impl ::core::fmt::Display for ERC20SnapshotCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AllowanceCall> for ERC20SnapshotCalls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for ERC20SnapshotCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for ERC20SnapshotCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BalanceOfAtCall> for ERC20SnapshotCalls {
        fn from(value: BalanceOfAtCall) -> Self {
            Self::BalanceOfAt(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for ERC20SnapshotCalls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<DecreaseAllowanceCall> for ERC20SnapshotCalls {
        fn from(value: DecreaseAllowanceCall) -> Self {
            Self::DecreaseAllowance(value)
        }
    }
    impl ::core::convert::From<IncreaseAllowanceCall> for ERC20SnapshotCalls {
        fn from(value: IncreaseAllowanceCall) -> Self {
            Self::IncreaseAllowance(value)
        }
    }
    impl ::core::convert::From<NameCall> for ERC20SnapshotCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for ERC20SnapshotCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for ERC20SnapshotCalls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TotalSupplyAtCall> for ERC20SnapshotCalls {
        fn from(value: TotalSupplyAtCall) -> Self {
            Self::TotalSupplyAt(value)
        }
    }
    impl ::core::convert::From<TransferCall> for ERC20SnapshotCalls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for ERC20SnapshotCalls {
