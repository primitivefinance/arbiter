...
pub mod block_timestamp {
    ...
    impl<M> ::core::ops::Deref for BlockTimestamp<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for BlockTimestamp<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for BlockTimestamp<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(BlockTimestamp)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> BlockTimestamp<M> {
