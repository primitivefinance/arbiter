...
pub mod ierc721_metadata {
    ...
    impl<M> ::core::fmt::Debug for IERC721Metadata<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IERC721Metadata)).field(&self.address()).finish()
        }
    }
