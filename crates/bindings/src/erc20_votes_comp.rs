...
pub mod erc20_votes_comp {
    ...
    pub static ERC20VOTESCOMP_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    impl ::ethers::core::abi::AbiDecode for ERC20VotesCompCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <GetPriorVotesCall as ::ethers::core::abi::AbiDecode>::decode(data) {
