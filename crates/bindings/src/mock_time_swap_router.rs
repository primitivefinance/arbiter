...
pub mod mock_time_swap_router {
    ...
    pub static MOCKTIMESWAPROUTER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static MOCKTIMESWAPROUTER_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static MOCKTIMESWAPROUTER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for MockTimeSwapRouter<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(MockTimeSwapRouter))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl ::core::convert::From<SelfPermitAllowedIfNecessaryCall> for MockTimeSwapRouterCalls {
