...
pub mod erc20_preset_fixed_supply {
    ...
    pub static ERC20PRESETFIXEDSUPPLY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static ERC20PRESETFIXEDSUPPLY_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static ERC20PRESETFIXEDSUPPLY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> ERC20PresetFixedSupply<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ERC20PresetFixedSupplyEvents>
        {
            self.0
