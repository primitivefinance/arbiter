...
pub mod access_control_enumerable {
    ...
    pub static ACCESSCONTROLENUMERABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl ::ethers::contract::EthLogDecode for AccessControlEnumerableEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(AccessControlEnumerableEvents::RoleAdminChangedFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<RoleAdminChangedFilter> for AccessControlEnumerableEvents {
