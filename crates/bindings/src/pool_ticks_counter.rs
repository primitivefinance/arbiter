...
pub mod pool_ticks_counter {
    ...
    impl<M> ::core::ops::Deref for PoolTicksCounter<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for PoolTicksCounter<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for PoolTicksCounter<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(PoolTicksCounter)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> PoolTicksCounter<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                POOLTICKSCOUNTER_ABI.clone(),
                POOLTICKSCOUNTER_BYTECODE.clone().into(),
                client,
            );
