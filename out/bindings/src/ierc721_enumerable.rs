pub use ierc721enumerable_mod::*;
#[allow(clippy::too_many_arguments)]
mod ierc721enumerable_mod {
    ...
    pub static IERC721ENUMERABLE_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for IERC721Enumerable<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> IERC721Enumerable<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                IERC721ENUMERABLE_BYTECODE.clone().into(),
                client,
            );
