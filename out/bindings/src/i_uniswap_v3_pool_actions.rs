pub use iuniswapv3poolactions_mod::*;
#[allow(clippy::too_many_arguments)]
mod iuniswapv3poolactions_mod {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for IUniswapV3PoolActions<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> IUniswapV3PoolActions<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                IUNISWAPV3POOLACTIONS_ABI.clone(),
                IUNISWAPV3POOLACTIONS_BYTECODE.clone().into(),
                client,
            );
