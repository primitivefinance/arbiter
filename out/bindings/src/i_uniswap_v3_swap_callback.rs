pub use iuniswapv3swapcallback_mod::*;
#[allow(clippy::too_many_arguments)]
mod iuniswapv3swapcallback_mod {
    ...
    pub static IUNISWAPV3SWAPCALLBACK_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            serde_json :: from_str ("[{\"inputs\":[{\"internalType\":\"int256\",\"name\":\"amount0Delta\",\"type\":\"int256\",\"components\":[]},{\"internalType\":\"int256\",\"name\":\"amount1Delta\",\"type\":\"int256\",\"components\":[]},{\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\",\"components\":[]}],\"stateMutability\":\"nonpayable\",\"type\":\"function\",\"name\":\"uniswapV3SwapCallback\",\"outputs\":[]}]") . expect ("invalid abi")
        });
    #[doc = r" Bytecode of the #name contract"]
    pub static IUNISWAPV3SWAPCALLBACK_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for IUniswapV3SwapCallback<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> IUniswapV3SwapCallback<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                IUNISWAPV3SWAPCALLBACK_ABI.clone(),
                IUNISWAPV3SWAPCALLBACK_BYTECODE.clone().into(),
                client,
            );
