...
mod vault_mod {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for Vault<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> Vault<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), VAULT_ABI.clone(), client).into()
        }
        ...
        #[doc = "Calls the contract's `deregisterTokens` (0x7d3aeb96) function"]
        ...
        #[doc = "Calls the contract's `exitPool` (0x8bdb3913) function"]
        pub fn exit_pool(
            &self,
            pool_id: [u8; 32],
        ...
        #[doc = "Calls the contract's `getDomainSeparator` (0xed24911d) function"]
        ...
        #[doc = "Calls the contract's `getInternalBalance` (0x0f5a6efa) function"]
        ...
        #[doc = "Calls the contract's `getNextNonce` (0x90193b7c) function"]
        ...
        #[doc = "Calls the contract's `getPool` (0xf6c00927) function"]
        pub fn get_pool(
            &self,
            pool_id: [u8; 32],
        ...
        #[doc = "Calls the contract's `getPoolTokenInfo` (0xb05f8e48) function"]
        ...
        #[doc = "Calls the contract's `getPoolTokens` (0xf94d4668) function"]
        ...
        #[doc = "Calls the contract's `getProtocolFeesCollector` (0xd2946c2b) function"]
        ...
        #[doc = "Calls the contract's `hasApprovedRelayer` (0xfec90d72) function"]
        ...
        #[doc = "Calls the contract's `joinPool` (0xb95cac28) function"]
        pub fn join_pool(
            &self,
            pool_id: [u8; 32],
            sender: ethers::core::types::Address,
        ...
        #[doc = "Calls the contract's `registerPool` (0x09b2760f) function"]
        ...
        #[doc = "Calls the contract's `registerTokens` (0x66a9c7d2) function"]
        ...
        #[doc = "Calls the contract's `setAuthorizer` (0x058a628f) function"]
        ...
        #[doc = "Calls the contract's `setRelayerApproval` (0xfa6e671d) function"]
        ...
        #[doc = "Calls the contract's `swap` (0x52bbbe29) function"]
        pub fn swap(
            &self,
        ...
        #[doc = "Gets the contract's `AuthorizerChanged` event"]
        pub fn authorizer_changed_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, AuthorizerChangedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `ExternalBalanceTransfer` event"]
        ...
        #[doc = "Gets the contract's `InternalBalanceChanged` event"]
        ...
        #[doc = "Gets the contract's `TokensDeregistered` event"]
        pub fn tokens_deregistered_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, TokensDeregisteredFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `TokensRegistered` event"]
    ...
    pub struct WethCall;
    #[doc = "Container type for all input parameters for the `deregisterTokens`function with signature `deregisterTokens(bytes32,address[])` and selector `[125, 58, 235, 150]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `exitPool`function with signature `exitPool(bytes32,address,address,(address[],uint256[],bytes,bool))` and selector `[139, 219, 57, 19]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getDomainSeparator`function with signature `getDomainSeparator()` and selector `[237, 36, 145, 29]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getInternalBalance`function with signature `getInternalBalance(address,address[])` and selector `[15, 90, 110, 250]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getNextNonce`function with signature `getNextNonce(address)` and selector `[144, 25, 59, 124]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getPool`function with signature `getPool(bytes32)` and selector `[246, 192, 9, 39]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getPoolTokenInfo`function with signature `getPoolTokenInfo(bytes32,address)` and selector `[176, 95, 142, 72]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getPoolTokens`function with signature `getPoolTokens(bytes32)` and selector `[249, 77, 70, 104]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `getProtocolFeesCollector`function with signature `getProtocolFeesCollector()` and selector `[210, 148, 108, 43]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `hasApprovedRelayer`function with signature `hasApprovedRelayer(address,address)` and selector `[254, 201, 13, 114]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `joinPool`function with signature `joinPool(bytes32,address,address,(address[],uint256[],bytes,bool))` and selector `[185, 92, 172, 40]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `registerPool`function with signature `registerPool(uint8)` and selector `[9, 178, 118, 15]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `registerTokens`function with signature `registerTokens(bytes32,address[],address[])` and selector `[102, 169, 199, 210]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `setAuthorizer`function with signature `setAuthorizer(address)` and selector `[5, 138, 98, 143]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `setRelayerApproval`function with signature `setRelayerApproval(address,address,bool)` and selector `[250, 110, 103, 29]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "Container type for all input parameters for the `swap`function with signature `swap((bytes32,uint8,address,address,uint256,bytes),(address,bool,address,bool),uint256,uint256)` and selector `[82, 187, 190, 41]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "`FundManagement(address,bool,address,bool)`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[doc = "`JoinPoolRequest(address[],uint256[],bytes,bool)`"]
    #[derive(
        Clone,
        Debug,
        Default,
