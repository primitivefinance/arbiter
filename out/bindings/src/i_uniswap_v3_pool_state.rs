pub use iuniswapv3poolstate_mod::*;
#[allow(clippy::too_many_arguments)]
mod iuniswapv3poolstate_mod {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for IUniswapV3PoolState<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> IUniswapV3PoolState<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                IUNISWAPV3POOLSTATE_BYTECODE.clone().into(),
                client,
            );
