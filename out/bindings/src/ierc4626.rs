...
mod ierc4626_mod {
    ...
    pub static IERC4626_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for IERC4626<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> IERC4626<M> {
