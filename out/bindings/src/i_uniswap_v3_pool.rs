pub use iuniswapv3pool_mod::*;
#[allow(clippy::too_many_arguments)]
mod iuniswapv3pool_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> IUniswapV3Pool<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                IUNISWAPV3POOL_BYTECODE.clone().into(),
                client,
            );
